    ...
    <div className="screen">
      ...
      <div style={{ padding: "16px 20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
          ...
          {task.autoGenerated && <Chip text="נוצרה אוטומטית" color="#7b8794" />}
          {task.seriesStoppedAt && <Chip text="הסדרה הופסקה" color="#e0224a" />}
        </div>
        ...
        {(task.checklist ?? []).length > 0 && (
          <Panel title={`שלבי ביצוע · ${doneSteps}/${(task.checklist ?? []).length}`}>
            <div style={{ height: 5, borderRadius: 999, background: "var(--line-soft)", overflow: "hidden", marginBottom: 10 }}>
              <div style={{ height: "100%", width: `${stepPercent}%`, background: stepPercent === 100 ? "#1f9e8a" : "#232a3b", borderRadius: 999 }} />
            </div>
                ...
                >
                  <span
                    style={{
                      ...
                      background: item.done ? "#1f9e8a" : "#ffffff",
                      color: "#ffffff",
                      fontSize: 12,
                      fontWeight: 900,
                      display: "flex",
          ...
          <Panel title="משימה קבועה">
            ...
            <button
              ...
              style={{
                ...
                width: "100%",
                background: "#ffffff",
                color: task.seriesStoppedAt ? "#1f9e8a" : "#e0224a",
                border: `1px solid ${task.seriesStoppedAt ? "#1f9e8a" : "#e0224a"}`,
              }}
            >
